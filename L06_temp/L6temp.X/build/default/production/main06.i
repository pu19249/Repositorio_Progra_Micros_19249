...
main:
    ...
    BCF ((PIR1) and 07Fh), 0 ;limpiar la bandera para el tmr1
    ...
    ;configurar TMR1
    BANKSEL T1CON
    BSF ((T1CON) and 07Fh), 5 ;prescaler de 1:8 para el timer1
    BSF ((T1CON) and 07Fh), 4
    BCF ((T1CON) and 07Fh), 1 ;internal clock FOSC/4
    BSF ((T1CON) and 07Fh), 0 ;enables timer1
...
; ;habilitar interrupciones para TMR1 y TMR2
    BANKSEL PIE1
    BSF ((PIE1) and 07Fh), 1 ;enables the timer2 to pr2 match interrupt
    BSF ((PIE1) and 07Fh), 0 ;enables the timer1 overflow interrupt
    BANKSEL PIR1
    BCF ((PIR1) and 07Fh), 1 ;limpiar banderas para timer2
    BCF ((PIR1) and 07Fh), 0 ;limpiar bandera de interrupcio para timer1
